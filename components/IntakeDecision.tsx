    ...
    <div className="print:hidden p-4 bg-white shadow-sm border-b">
      <div className="max-w-4xl mx-auto py-10 space-y-10">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900">How do you want to get started?</h1>
          <p className="text-sm text-gray-600">
            We'll tailor the experience based on whether you already have a JSON export of your resume.
          </p>
        </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">I already have JSON</h2>
                  <p className="text-sm text-gray-600">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Help me create JSON</h2>
                  <p className="text-sm text-gray-600">
                    Generate JSON with your favorite AI or let BuiltIt convert your existing resume.
                  </p>
                </div>
              </div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-600">
              ...
              <li className="flex items-center gap-2">
                ...
                Optionally paste your resume text and we'll convert it
              </li>
              <li className="flex items-center gap-2">
