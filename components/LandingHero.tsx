...
const LandingHero: FC<LandingHeroProps> = ({ onSeeDemo, onStartOwn }) => (
  <section className="relative isolate overflow-hidden rounded-b-3xl rounded-t-none border border-slate-200 bg-landing-hero text-white shadow-2xl shadow-slate-900/20">
    <div className="absolute inset-0 bg-gradient-to-b from-white/15 via-white/5 to-transparent opacity-70" style={{ height: '144px' }} />
    <div className="relative px-6 py-16 sm:px-10 lg:px-28 lg:py-20">
      <div className="mx-auto flex w-full max-w-[1100px] flex-col gap-8">
        ...
        <div className="rounded-2xl border border-white/10 bg-gradient-highlight p-6 text-left shadow-2xl shadow-blue-900/30">
